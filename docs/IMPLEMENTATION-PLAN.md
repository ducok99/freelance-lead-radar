...
v0.5 — 2026-07-20 — P0–P3 đã duyệt; P4 hoàn thành code + QA tự động, chờ smoke test và DUC nghiệm thu.
...
- [ ] `wrangler dev` + curl trên máy DUC: README đã có lệnh; Wrangler dry-run bundle thành công nhưng sandbox Codex không cho bind network interface (`uv_interface_addresses`).
