...
v0.8 — 2026-07-20 — P0–P4 đã duyệt; P5.1 smoke Chrome đạt, chờ E2E CI và DUC duyệt; P6 chưa được phép.
...
- [ ] e2e Playwright đầu tiên: load extension + fixture page nhóm-ngoài-allowlist → 0 sự kiện/ghi nhận lead (test đã viết và đưa vào CI; chờ run xanh).
