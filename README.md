...
**Trạng thái (cập nhật 2026-07-20):** P0–P2 đã được DUC duyệt và GitHub Actions chạy xanh; P3 (`fixtures/facebook` + `packages/facebook-adapter`) đã hoàn thành local, đang chờ DUC nghiệm thu. Chưa bắt đầu P4.
